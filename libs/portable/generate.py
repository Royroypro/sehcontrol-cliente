...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("sehcontrol".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../sehcontrol-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\sehcontrol\flutter\build\windows\runner\Debug\ -o . -e ..\sehcontrol\flutter\build\windows\runner\Debug\sehcontrol.exe
