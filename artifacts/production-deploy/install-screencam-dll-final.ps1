...
$candidateDll      = 'C:\tmp\sehcontrol-entrega4-68b7d4ed6\artifacts\production-deploy\sehcontrol-screencam-final-release.dll'
$expectedCandidate = '8753E8D4D61A0D3E96A87FE9ABF0D542866055E1F1C8DC5EA5BD50D2EA43FF98'
$logDirectory      = 'C:\ProgramData\Sehcontrol'
$logPath           = Join-Path $logDirectory 'screencam-deploy-final.log'
