...
$candidateDll      = 'C:\tmp\sehcontrol-entrega4-68b7d4ed6\artifacts\production-deploy\sehcontrol-screencam-sendbuffer-release.dll'
$expectedCandidate = 'E125323D5FF5F90508A550BE9C39E136B7ACF24F8348C3888602949E15A2BC72'
$logDirectory      = 'C:\ProgramData\Sehcontrol'
$logPath           = Join-Path $logDirectory 'screencam-deploy-20260803b.log'
