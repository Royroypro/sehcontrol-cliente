...
Sehcontrol 또는 그 종속성에 대한 기여는 GitHub 풀 리퀘스트 형태로 
...
- 패치가 검토되지 않거나 특정인이 검토해야 하는 경우, 풀 리퀘스트나
 ...
 [이메일](mailto:info@sehcontrol.com)을 통해 검토를 요청할 수 있습니다.
...
Sehcontrol 기여자들은 [Discord](https://discord.gg/nDceKgxnkV)에서 활동하고 있습니다.
