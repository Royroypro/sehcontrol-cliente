...
/// The Linux bundle keeps the core library at lib/sehcontrol.so next to the
...
DynamicLibrary _openLinuxCoreLib() {
  final bundled =
      '${File(Platform.resolvedExecutable).parent.path}/lib/sehcontrol.so';
  try {
  ...
  return DynamicLibrary.open('sehcontrol.so');
}
