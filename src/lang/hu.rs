...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a Sehcontrol alkalmazást a számítógépére."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a Sehcontrol számára a „Hozzáférhetőség” szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a „Sehcontrol Input” szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep Sehcontrol background service", "Sehcontrol futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a Sehcontrol alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show Sehcontrol", "A Sehcontrol megjelenítése"),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az „Igen” gombra kell kattintania a Sehcontrol UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "Sehcontrol jelszó megerősítése"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Frissítse a Sehcontrol Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a Sehcontrol nem fut megfelelően, mint ellenőrzött."),
        ...
        ("powered_by_me", "Üzemeltető: Sehcontrol"),
        ("outgoing_only_desk_tip", "Ez a Sehcontrol testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a Sehcontrol ablaka nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a Sehcontrol a háttérben fut."),
        ...
        ("About Sehcontrol", "A Sehcontrol névjegye"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Frissítse a Sehcontrol klienst {} vagy újabb verziójára a távoli oldalon!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Alapértelmezés szerint a Sehcontrol ellenőrzi a kiszolgáló tanúsítványát a TLS-protokollok esetében. Ha ez a beállítás engedélyezve van, a Sehcontrol kihagyja az ellenőrzési lépést, és az ellenőrzés sikertelensége esetén folytatja a műveletet."),
        ("Disable UDP", "UDP letiltása"),
        ("disable-udp-tip", "Meghatározza, hogy csak TCP-t használjon-e. Ha ez az beállítás engedélyezve van, a Sehcontrol nem fogja többé használni a 21116-os UDP-portot, helyette a 21116-os TCP-portot fogja használni."),
        ("server-oss-not-support-tip", "MEGJEGYZÉS: Az OSS Sehcontrol kiszolgáló nem támogatja ezt a funkciót."),
