...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة Sehcontrol..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. Sehcontrol قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت Sehcontrol في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح Sehcontrol اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح Sehcontrol اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ Sehcontrol باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [Sehcontrol Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep Sehcontrol background service", "ابق خدمة Sehcontrol تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق Sehcontrol, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show Sehcontrol", "عرض Sehcontrol"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من Sehcontrol اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح Sehcontrol اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في Sehcontrol الذي يعمل."),
        ...
        ("verify_rustdesk_password_tip", "تحقق من كلمة مرور Sehcontrol"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "ترقية خادم Sehcontrol Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع Sehcontrol"),
        ...
        ("About Sehcontrol", "حول Sehcontrol"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "ترقية عميل Sehcontrol البعيد إلى {}"),
