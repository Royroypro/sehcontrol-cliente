...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red Sehcontrol en progreso..."),
        ...
        ("Website", "Sitio web"),
        ("About", "Acerca de"),
        ("Slogan_tip", "¡Control inteligente para un mundo conectado.!"),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que Sehcontrol no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar Sehcontrol a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Sehcontrol de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a Sehcontrol de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que Sehcontrol use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [Sehcontrol Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep Sehcontrol background service", "Dejar Sehcontrol como Servicio en 2do plano"),
        ...
        ("Show Sehcontrol", "Mostrar Sehcontrol"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a Sehcontrol permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a Sehcontrol permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de Sehcontrol"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses Sehcontrol e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "¡Por favor, actualiza Sehcontrol Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que Sehcontrol no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de Sehcontrol"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de Sehcontrol de fondo"),
        ...
        ("About Sehcontrol", "Acerca de Sehcontrol"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente Sehcontrol a la versión {} o superior en el lado remoto"),
        ...
        ("membership_protection_tagline", "Protección avanzada"),
        ("ScreenCam", "ScreenCam"),
        ("screencam_status_running", "Transmitiendo"),
        ...
        ("Preview failed", "No se pudo previsualizar"),
        ...
        ("Details", "Viñetas"),
        ("Tiles", "Mosaico"),
        ("Organize by date", "Organizar por fecha"),
        ("Today", "Hoy"),
        ("Yesterday", "Ayer"),
        ("files", "archivos"),
        ("Monday", "Lunes"),
