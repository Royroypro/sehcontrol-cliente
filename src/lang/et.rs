...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa Sehcontrol mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et Sehcontrol oma süsteemi paigaldada."),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [Sehcontrol Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep Sehcontrol background service", "Säilita RustDeski taustateenus"),
        ...
        ("Show Sehcontrol", "Kuva Sehcontrol"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda Sehcontrol Server Pro versioonile {} või uuem!"),
        ...
        ("About Sehcontrol", "RustDeski teave"),
