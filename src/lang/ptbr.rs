...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do Sehcontrol..."),
        ...
        ("install_tip", "Devido ao UAC, o Sehcontrol não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Sehcontrol no sistema."),
        ("Click to upgrade", "Clique para fazer o upgrade"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao Sehcontrol permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao Sehcontrol permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o Sehcontrol use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [Sehcontrol Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep Sehcontrol background service", "Manter o serviço do Sehcontrol executando em segundo plano"),
        ...
        ("Show Sehcontrol", "Exibir Sehcontrol"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do Sehcontrol."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do Sehcontrol."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do Sehcontrol."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do Sehcontrol"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o Sehcontrol e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o Sehcontrol Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o Sehcontrol funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por Sehcontrol"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do Sehcontrol estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço Sehcontrol em segundo plano"),
        ...
        ("About Sehcontrol", "Sobre Sehcontrol"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente Sehcontrol para a versão {} ou superior no lado remoto."),
