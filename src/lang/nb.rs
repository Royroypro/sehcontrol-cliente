...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til Sehcontrol-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan Sehcontrol ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere Sehcontrol på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi Sehcontrol \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi Sehcontrol \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi Sehcontrol mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [Sehcontrol Input] tjenesten."),
        ...
        ("verify_rustdesk_password_tip", "Verifiser Sehcontrol-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke Sehcontrol og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Vennligst oppgrader Sehcontrol Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre Sehcontrol i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av Sehcontrol"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis Sehcontrol-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde Sehcontrol-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Vennligst oppgrader Sehcontrol-klienten til versjon {} eller nyere på fjernsiden!"),
