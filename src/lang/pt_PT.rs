...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do Sehcontrol..."),
        ...
        ("install_tip", "Devido ao UAC, o Sehcontrol não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o Sehcontrol no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao Sehcontrol permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao Sehcontrol permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o Sehcontrol use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [Sehcontrol Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep Sehcontrol background service", "Manter o serviço Sehcontrol em funcionamento"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao Sehcontrol as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao Sehcontrol as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do Sehcontrol em execução."),
        ...
        ("verify_rustdesk_password_tip", "Verificar palavra-passe do Sehcontrol"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o Sehcontrol e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o Sehcontrol Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o Sehcontrol de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo Sehcontrol"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do Sehcontrol estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do Sehcontrol"),
        ...
        ("About Sehcontrol", "Sobre o Sehcontrol"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente Sehcontrol para a versão {} ou mais recente no lado remoto!"),
