...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto Sehcontrol..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali Sehcontrol sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al Sehcontrol."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al Sehcontrol."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al Sehcontrol uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [Sehcontrol Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep Sehcontrol background service", "Tenu Sehcontrol fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de Sehcontrol, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("Show Sehcontrol", "Montri Sehcontrol"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al Sehcontrol permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al Sehcontrol permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta Sehcontrol."),
        ...
        ("verify_rustdesk_password_tip", "Kontroli Sehcontrol-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi Sehcontrol kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bonvolu ĝisdatigi Sehcontrol Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi Sehcontrol funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de Sehcontrol"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de Sehcontrol estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de Sehcontrol"),
        ...
        ("About Sehcontrol", "Pri Sehcontrol"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bonvolu ĝisdatigi la Sehcontrol-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
