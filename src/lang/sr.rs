...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na Sehcontrol mrežu..."),
        ...
        ("install_tip", "Zbog UAC Sehcontrol ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Sehcontrol na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, Sehcontrol-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Sehcontrol-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite Sehcontrol-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [Sehcontrol Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep Sehcontrol background service", "Zadrži Sehcontrol kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Sehcontrol aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show Sehcontrol", "Prikazi Sehcontrol"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite Sehcontrol-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite Sehcontrol-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog Sehcontrol-a."),
        ...
        ("verify_rustdesk_password_tip", "Potvrdi Sehcontrol lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite Sehcontrol i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Molimo nadogradite Sehcontrol Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti Sehcontrol da radi pravilno kao kontrolisana strana."),
        ...
        ("powered_by_me", "Pokreće Sehcontrol"),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je Sehcontrol prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se Sehcontrol pozadinski servis održi"),
        ...
        ("About Sehcontrol", "O Sehcontrol-u"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo nadogradite Sehcontrol klijent na verziju {} ili noviju na udaljenoj strani!"),
