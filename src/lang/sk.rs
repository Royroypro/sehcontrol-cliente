...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na Sehcontrol server..."),
        ...
        ("install_tip", "V niektorých prípadoch Sehcontrol nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii Sehcontrol udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii Sehcontrol udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii Sehcontrol udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [Sehcontrol Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep Sehcontrol background service", "Ponechať službu Sehcontrol na pozadí"),
        ...
        ("Show Sehcontrol", "Zobraziť Sehcontrol"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie Sehcontrol \"Sledovanie vstupu\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu Sehcontrol."),
        ...
        ("verify_rustdesk_password_tip", "Overenie hesla Sehcontrol"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie Sehcontrol, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte Sehcontrol Server Pro na verziu {} alebo novšiu!"),
        ...
        ("powered_by_me", "Poháňané aplikáciou Sehcontrol"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie Sehcontrol"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu Sehcontrol na pozadí"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aktualizujte klienta Sehcontrol na verziu {} alebo novšiu na vzdialenej strane!"),
