...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Sehcontrol..."),
        ...
        ("install_tip", "Do cơ chế UAC, Sehcontrol có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Sehcontrol vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Sehcontrol."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Sehcontrol."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Sehcontrol Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Sehcontrol background service", "Giữ dịch vụ Sehcontrol chạy nền"),
        ...
        ("Show Sehcontrol", "Hiện Sehcontrol"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Sehcontrol"),
        ...
        ("scam_text2", "Chỉ sử dụng Sehcontrol với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Sehcontrol mở"),
        ...
        ("floating_window_tip", "Giữ Sehcontrol trên cùng"),
        ...
        ("About Sehcontrol", "Về Sehcontrol"),
