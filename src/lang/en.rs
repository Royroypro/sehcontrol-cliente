...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Due to UAC, Sehcontrol can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Sehcontrol to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Sehcontrol \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Sehcontrol \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Sehcontrol to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Sehcontrol Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Sehcontrol application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Sehcontrol \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Sehcontrol \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Sehcontrol."),
        ...
        ("verify_rustdesk_password_tip", "Verify Sehcontrol password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Sehcontrol and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Sehcontrol Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Sehcontrol from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by Sehcontrol"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Sehcontrol window is open"),
        ...
        ("floating_window_tip", "It helps to keep Sehcontrol background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Sehcontrol client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Sehcontrol verifies the server certificate for protocols using TLS.\nWith this option enabled, Sehcontrol will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Sehcontrol will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Sehcontrol server OSS doesn't include this feature."),
        ...
        ("membership_protection_tagline", "Advanced protection"),
        ("ScreenCam", "ScreenCam"),
        ("screencam_status_running", "Streaming"),
        ("screencam_status_starting", "Starting..."),
        ("screencam_status_error", "Error"),
        ("screencam_status_disabled", "Off"),
        ("screencam_status_unsupported", "This machine does not meet the minimum requirements"),
        ("screencam_status_not_configured", "Not available on this device"),
        ("screencam_managed_from_panel_tip", "Managed from your account's web panel."),
        ("screencam_auth_required_tip", "This stream requires a username and password"),
        ("Copy", "Copy"),
        ...
        ("sehcontrol_pro_tip", "More speed, unlimited history, and advanced features."),
