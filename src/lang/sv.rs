...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Sehcontrol..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Sehcontrol fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Sehcontrol på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge Sehcontrol \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Sehcontrol \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Sehcontrol Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep Sehcontrol background service", "Behåll Sehcontrol i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Sehcontrol programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show Sehcontrol", "Visa Sehcontrol"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
