...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään Sehcontrol verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa Sehcontrol ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi RustDeskin järjestelmään."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten Sehcontrol daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli Sehcontrol ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "Sehcontrol palvelu käynnistyy taustalla."),
        ...
        ("android_start_service_tip", "Sehcontrol palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep Sehcontrol background service", "Pidä RustDeskin taustapalvelu käynnissä"),
        ...
        ("Show Sehcontrol", "Näytä Sehcontrol"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista Sehcontrol salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "Sehcontrol ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Päivitä Sehcontrol Server Pro versioon {} jatkaaksesi."),
        ...
        ("About Sehcontrol", "Tietoa RustDeskistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-Sehcontrol-asiakasversioon {} yhteensopivuuden takaamiseksi"),
