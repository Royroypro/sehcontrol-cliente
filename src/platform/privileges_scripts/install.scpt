on run {daemon_file, agent_file, user}
  ...
  set sh3 to "cp -rf " & prefs_toml & " /var/root/Library/Preferences/com.carriez.Sehcontrol/;"

  set sh4 to "cp -rf " & prefs2_toml & " /var/root/Library/Preferences/com.carriez.Sehcontrol/;"
