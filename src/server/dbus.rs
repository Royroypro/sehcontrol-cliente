...
///
/// Note:
/// On linux, we use dbus to communicate between multiple sehcontrol processes.
...
const DBUS_NAME: &str = "org.sehcontrol.sehcontrol";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Sehcontrol DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.sehcontrol.sehcontrol /dbus org.sehcontrol.sehcontrol.NewConnection string:'PEER_ID'`
