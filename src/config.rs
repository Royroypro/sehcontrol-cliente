...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Sehcontrol".to_owned());
...
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("sehcontrol docs home", LINK_DOCS_HOME),
        ("sehcontrol docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("sehcontrol x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
